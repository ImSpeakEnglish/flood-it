...
public class ScreenKTU extends Canvas 
    ...
    final protected JFrame mainFrame = new JFrame("\u00a9 KTU IF \u00a9");
...
// šis metodas naudoja Lambda notaciją
    ...
    final public void fillRect(int rowTop, int columnLeft, int countRow, int countColumn){
        if(grid==0){
    ...
    final public void fillRect(int rowTop, int columnLeft, int countRow, int countColumn, char ch){
        for(int row=rowTop; row<rowTop+countRow; row++)
          for(int col=columnLeft; col<columnLeft+countColumn; col++)
              print(row, col, ch);
    }
    final public void fillRect(int rowTop, int columnLeft, int countRow, int countColumn, Color bc){
        if(grid==0){
            int x = columnLeft * cellW;
            int y = rowTop * cellH;
            g.setColor(bc);
    ...
    final public void fillBorder(int rowTop, int columnLeft, int countRow, int countColumn, char ch){
        for(int row=rowTop; row<rowTop+countRow; row++){
    ...
    final public void fillBorder(int rowTop, int columnLeft, int countRow, int countColumn){
        for(int row=rowTop; row<rowTop+countRow; row++){
    ...
    final public void fillBorder(int rowTop, int columnLeft, int countRow, int countColumn, Color bc){
        for(int row=rowTop; row<rowTop+countRow; row++){
    ...
    final public void lineBorder(int rowTop, int columnLeft, int countRow, int countColumn, int lineType){
    ...
    final public void drawLine(int rowTop, int columnLeft, int countRow, int countColumn, int lineType){
